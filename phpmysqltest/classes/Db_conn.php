...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'hlamble';//this will be your WCC username
      $dbUsr = 'hlamble';//this will be your WCC username
      $dbPass = 'R5U2jfuwDf8Y';//this will be the password found in the video.
